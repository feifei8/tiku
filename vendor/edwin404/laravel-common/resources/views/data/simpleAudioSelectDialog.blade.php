...
@section('headAppend')
    ...
    <style type="text/css">
        ...
        #list .item .image{width: 120px;height: 120px;border: 1px solid #EEE;position: relative;background:#EEE;}
        #list .item .image span{line-height:120px;display:block;text-align:center;font-size:80px;color:#666;}
...
@section('bodyAppend')
    ...
    <script src="@assets('assets/basic/js/simpleDataAudioSelectDialog.js')"></script>
@endsection
