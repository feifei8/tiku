...
<head>
    <meta charset="utf-8">
    <title>[{{\Edwin404\Config\Facades\ConfigFacade::get('siteName')}}] @yield('pageTitle')</title>
    <style type="text/css">
...
<div id="wrap">
    <div id="head">
        <a class="logo" href="http://{{\Edwin404\Config\Facades\ConfigFacade::get('siteDomain')}}" target="_blank">
            {{\Edwin404\Config\Facades\ConfigFacade::get('siteName')}}
        </a>
    </div>
    @section('body')
        <div id="content">
        ...
        <div id="foot">
            {{\Edwin404\Config\Facades\ConfigFacade::get('siteName')}} &copy; {{\Edwin404\Config\Facades\ConfigFacade::get('siteDomain')}} 版权所有
        </div>
    @show
</div>
</body>
