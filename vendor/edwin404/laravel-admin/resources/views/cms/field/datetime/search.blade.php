...
@else
    ...
    @if(in_array('rangeDate',$field['searchType']))
        <div class="item">
            ...
            <div class="field">
                <input data-date-picker type="text" value="" data-search-field="{{$key}}" data-search-group="{{$key}}Range" data-search-type="min" style="width:11em;" />
                -
                <input data-date-picker type="text" value="" data-search-field="{{$key}}" data-search-group="{{$key}}Range" data-search-type="max" style="width:11em;" />
            </div>
        </div>
    @endif
@endif