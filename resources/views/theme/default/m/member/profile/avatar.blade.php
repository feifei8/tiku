...
@section('bodyScript')
    <script src="@assets('assets/m/default/memberAvatar.js')"></script>
@endsection
    ...
    <div class="pb-member-avatar">
        ...
        <div id="avatarBox">
            <div class="preview" id="oldAvatarBox">
                <img src="{{\Edwin404\SmartAssets\Helper\AssetsHelper::fixOrDefault($_memberUser['avatarBig'],'assets/lib/img/avatar.png')}}">
            </div>
        </div>
