        ...
        <div class="pb-form">
            ...
            <div class="mui-input-group">
                <div class="mui-input-row mui-radio mui-left">
                    <label>男</label>
                    <input name="gender" type="radio" value="{{\Edwin404\Member\Types\Gender::MALE}}" @if($_memberUser['gender']==\Edwin404\Member\Types\Gender::MALE) checked @endif />
                </div>
                <div class="mui-input-row mui-radio mui-left">
                    <label>女</label>
                    <input name="gender" type="radio" value="{{\Edwin404\Member\Types\Gender::FEMALE}}" @if($_memberUser['gender']==\Edwin404\Member\Types\Gender::FEMALE) checked @endif />
                </div>
                <div class="mui-input-row mui-radio mui-left">
                    <label>保密</label>
                    <input name="gender" type="radio" value="{{\Edwin404\Member\Types\Gender::UNKNOWN}}" @if($_memberUser['gender']==\Edwin404\Member\Types\Gender::UNKNOWN) checked @endif />
                </div>
            </div>
